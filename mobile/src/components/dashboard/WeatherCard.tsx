  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.waveCardWrapper}>
        ...
        >
          <Defs>
            {/* SQUI Signature Bright Nature Emerald Gradient (Matching Bento Stats Cards) */}
            ...
            <SvgRadialGradient
              ...
              fx="80%"
              fy="25%"
            ><Stop offset="0%" stopColor="#FFFBEB" stopOpacity={0.9} /><Stop offset="15%" stopColor="#BAE6FD" stopOpacity={1} /><Stop offset="55%" stopColor="#38BDF8" /><Stop offset="100%" stopColor="#0369A1" /></SvgRadialGradient>
          </Defs>
          ...
          {/* Volumetric Cloud Shadow (Volumetric Concentric Glows) */}
          <Ellipse
            cx="284"
            cy="138"
            rx="64"
          ...
          {/* 🌊 Sculpted Wave Card Body: Rounder Corners (R34) & Full Height 235 */}
          <Path
          ...
          {/* Frosted Outer Card Border to enclose the full rect */}
          <Rect
            x="0"
            y="0"
            width="350"
        ...
        <View style={styles.cardContent}>
          {/* Top Row: Temp Info (Left) + 3D Mascot Illustration (Right, in Wave Dip) */}
          <View style={styles.mainRow}>
            ...
            {/* Right: 3D Mascot Illustration (Protruding from Wave Dip) */}
        ...
        {hourlyForecast.map((item, index) => (
          ...
          >
            ...
            <View style={styles.forecastIconWrap}>
              {item.iconType === 'rain' && <Text style={{ fontSize: 13 }}>🌧️</Text>}
              {item.iconType === 'moon' && <Text style={{ fontSize: 13 }}>🌙</Text>}
              {item.iconType === 'sun' && <Text style={{ fontSize: 13 }}>☀️</Text>}
              {item.iconType === 'cloud' && <Text style={{ fontSize: 13 }}>⛅</Text>}
            </View>
            {item.chance ? (
